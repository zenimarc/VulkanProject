...
glm::mat4 LookInDirMat(glm::vec3 Pos, glm::vec3 Angs) {
    glm::mat4 out =
        glm::rotate(glm::mat4(1), -Angs.z, glm::vec3(0,0,1)) *
        glm::rotate(glm::mat4(1), -Angs.y, glm::vec3(1,0,0)) *
        glm::rotate(glm::mat4(1), -Angs.x, glm::vec3(0,1,0)) *
