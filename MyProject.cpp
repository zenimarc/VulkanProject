...
protected:
	...
	void updateUniformBuffer(uint32_t currentImage)
	{
        ...
        }else if(RobotPos[1]>10){
            if (!isInside(polygonSecondLevel, sizeof(polygonSecondLevel)/sizeof(polygonSecondLevel[0]), {RobotPos[0], RobotPos[2]})) {
                RobotPos = oldRobotPos;
            }
        }else{
